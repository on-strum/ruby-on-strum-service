# Contributing to `on_strum-service`
...
3. `on_strum-service` [issue template](.github/ISSUE_TEMPLATE/issue_report.md)/[bug template](.github/ISSUE_TEMPLATE/bug_report.md)
...
1. `on_strum-service` [pull request template](.github/PULL_REQUEST_TEMPLATE.md)
